...
def LoginFrame1():
    ...
    username_label = Label(main_frame,text = "UserName - ",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Blue").place(x = 40,y =90);
    password_label = Label(main_frame,text = "Password - ",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Blue").place(x = 40,y =140);
    ...
    loginButt = Button(main_frame,text = "Login",font = ("Ink Free",15,"bold"),command = CredentialCheck,fg = "Red",bg = "Black",width = 10).place(x = 130,y = 214);
    clearButt = Button(main_frame,text = "Clear",font = ("Ink Free",15,"bold"),command = Clear_F1,fg = "Red",bg = "Black",width = 10).place(x = 278 ,y = 214);
    exitButt =  Button(main_frame, text = "Exit",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",command = main_frame.destroy,width = 10).place(x = 425,y = 214);
    main_frame.mainloop();
...
def CredentialCheck():
    ...
    if userna == "" or pas == "":
        ...
        mycur=mydb.cursor()
        mycur.execute("CREATE TABLE IF NOT EXISTS credentials_login_registration(First_Name char(30), Last_Name char(30), Email_ID varchar(40), UserName varchar(40),Password varchar(100))");
...
def RegisterForm():
    ...
    bg = Image.open("l.jpg").resize((700,600));
    img = ImageTk.PhotoImage(bg,master  = rframe);
    lbl = Label(rframe,image = img).pack(pady = 0.5 );
    fname = Label(rframe,text = "FirstName",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 160,y =90);
    lname = Label(rframe,text = "LastName",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 400,y =90);
    ...
    Email = Label(rframe,text = "Email ID",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 160,y =180);
    emailentry3 = Entry(rframe,width = 51,borderwidth = 3,font = ("Times New Roman",12,"bold"));
    emailentry3.place(x = 140,y = 230);
    uname = Label(rframe,text = "Username",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 160,y =270);
    uentry4 = Entry(rframe,width = 51,borderwidth = 3,font = ("Times New Roman",12,"bold"));
    uentry4.place(x = 140,y = 310);
    p = Label(rframe,text = "Password",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 160,y =350);
    pentry5 = Entry(rframe,width = 51,borderwidth = 3,show = "*",font = ("Times New Roman",12,"bold"));
    pentry5.place(x = 140,y = 390);
    cp = Label(rframe,text = "Confirm Password",font = ("Ink Free",20,"bold"),bg = "Black",fg = "Orange").place(x = 160,y =430);
    cpentry6 = Entry(rframe,width = 51,borderwidth = 3,show = "*",font = ("Times New Roman",12,"bold"));
    cpentry6.place(x = 140,y = 470);
    registerButt = Button(rframe,text = "Register",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 10,command = Register).place(x = 60,y = 520);
    clearButt = Button(rframe,text = "Clear",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 10,command = ClearRegForm).place(x = 205 ,y = 520);
    backButt = Button(rframe,text = "Back",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 10,command =  backRegForm).place(x = 350 ,y = 520);
    exitButt =  Button(rframe, text = "Exit",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",command = rframe.destroy,width = 10).place(x = 495,y = 520);
    rframe.mainloop();
...
def Register():
    ...
    if p != cp:
        ...
        mycur = mydb.cursor();
        val= [(fn,ln,ei,un,cp)];
        sql="INSERT INTO credentials_login_registration(First_Name,Last_Name,Email_ID,UserName,Password)VALUES (%s,%s,%s,%s,%s)";
...
def MDPFrame2():
    ...
    bg = Image.open("img2.jpg").resize((800,570));
    ...
    f2.config(menu = m);
    MedIDLabel1 = Label(f2,text = "MedicineID -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =100);
    MedNameLabel2 = Label(f2,text = "MedicineName -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =150);
    DesLabel3 = Label(f2,text = "Description -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =200);
    StavLabel4 = Label(f2,text = "StockAvalablity -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =250);
    LocLabel5 = Label(f2,text = "Location -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =300);
    PrioLabel6 = Label(f2,text = "Priority -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =350);
    ExpLabel5 = Label(f2,text = "Expiry -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =400);
    ...
    priceLabel5 = Label(f2,text = "Price -",font = ("Ink Free",20,"bold"),fg = "Green").place(x = 40,y =450);
    ...
    clearbtn = Button(f2,text = "Clear",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 10,command = clear_F2).place(x = 310,y = 510);
    Exitbtn = Button(f2,text = "Exit",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 10,command = f2.destroy).place(x = 500,y = 510);
    f2.mainloop();     
...
def vrm():
    ...
    if user != "admin" and password != "admin":  
        ...
        tree["columns"] = ("First_Name","Last_Name","Email_ID","UserName","Password");
...
def billing():
    f2.destroy();
    global f6,ne1,ne2,ne3,ne4,ne5,ne6,ne7,ne8,ne9,ne10,ne11;
    f6 = Tk();
    ...
    l7 = Label(f6,text = "Price",font = ("Helvetica",15),bg = "#fac898",fg = "Black").place(x = 680,y =400);
    ...
    calbtn =  Button(f6, text = "Calculate",font = ("Ink Free",15,"bold"),fg = "Red",bg = "Black",width = 20,command = calculation).place(x = 900,y = 300);
...
def vph():
    ...
    f7.geometry("1013x500");
    f7.config(bg= "#fac898");
    Label(f7,text = "Purchase History",justify = "center",font = ("Ink Free",35,"bold"),fg = "Red",bg = "Black",width = 300).pack();
    mydb = mysql.connector.connect(host = "localhost",user = "root",password = "admin",database = "medical_inventory_system_python");
    mycur = mydb.cursor();
    mycur.execute("CREATE TABLE IF NOT EXISTS purchase_record(Name_of_The_Customer varchar(200),Phone bigint,Email_ID varchar(100),Age int,Medicine_Name varchar(50),Quantity int, Price float, Total_Amount_Rs float,GST_Applicable float, Discount float,Net_Amount_Rs float)");
    mycur.execute("SELECT Name_of_The_Customer,Phone,Email_ID,Age,Total_Amount_Rs,GST_Applicable,Discount,Net_Amount_Rs FROM purchase_record");
    tree = ttk.Treeview(f7);
    tree["show"] = "headings";
    s = ttk.Style(f7);
    s.configure(".",font = ("Helvetica",9));
    s.configure("Treeview.Heading",foreground = "Red",font = ("Helvetica",9,"bold"));
    tree["columns"] = ("Name_of_The_Customer","Phone","Email_ID","Age","Total_Amount_Rs" ,"GST_Applicable","Discount","Net_Amount_Rs");
    tree.column("Name_of_The_Customer",width = 120,minwidth = 50,anchor = CENTER);
    tree.column("Phone",width = 120,minwidth = 50,anchor = CENTER);
    tree.column("Email_ID",width = 120,minwidth = 50,anchor = CENTER);
    ...
    tree.column("Discount",width = 120,minwidth = 50,anchor = CENTER);
    tree.column("Net_Amount_Rs",width = 120,minwidth = 50,anchor = CENTER);
...
def addbill():
    ...
    n_e6 = ne6.get();
    n_e7 = ne7.get();
    if n_e1 == "" or n_e2 == "" or n_e3 == "" or n_e4 == "" or n_e5 == "" or n_e6 == "" or n_e7 == "":
...
def calculation():
    ...
    mycursor.execute("CREATE TABLE IF NOT EXISTS purchase_record(Name_of_The_Customer VARCHAR(200),Phone BIGINT,Email_ID VARCHAR(100),Age INT,Medicine_Name VARCHAR(50),Quantity INT,Price FLOAT,Total_Amount_Rs FLOAT,GST_Applicable FLOAT,Discount FLOAT,Net_Amount_Rs FLOAT )");
    val= [(n_e1,n_e2,n_e3,n_e4,n_e5,n_e6,n_e7,n_e8,n_e9,n_e10,n_e11)];
    sql="INSERT INTO purchase_record(Name_of_The_Customer,Phone,Email_ID,Age,Medicine_Name ,Quantity,Price ,Total_Amount_Rs ,GST_Applicable,Discount,Net_Amount_Rs)VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)";
    mycursor.executemany(sql,val);
    mydb.commit();
...
def add_to_invent():
   ...
   # elif e > td:
        messgaebox.showinfo("","Sorry Medicine is Expired ,Can't Add to inventory");
